...
spawn(function()
	...
	Misc:AddButtonLeft("Teleport To Island",function()
		for i, v in pairs(workspace.Storage:GetChildren()) do
			if v:FindFirstChild("oceanNameTemplate") and v.oceanNameTemplate:FindFirstChild("oceanName") then
				if v.oceanNameTemplate.oceanName.Text == _G.SST.Select_Island then
